...
class bluelikeViewController: UIViewController, MCSessionDelegate, MCBrowserViewControllerDelegate
{
    ...
    func session(_ session: MCSession, didReceive data: Data, fromPeer peerID: MCPeerID) {
        if let image = UIImage(data: data) {
            ...
            DispatchQueue.main.async {
                ...
                UIImageWriteToSavedPhotosAlbum(image, self, #selector(bluelikeViewController.image(_:didFinishSavingWithError:contextInfo:)), nil)
            }
        }
    }
