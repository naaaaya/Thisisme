//
//  bluefriendsViewController.swift
//  koushien
//
...
class bluefriendsViewController: UIViewController, MCSessionDelegate, MCBrowserViewControllerDelegate
{
    ...
    override func viewDidLoad() {
        ...
        let base64String:String? = userDefaults.string(forKey: "profile2")
    ...
    func session(_ session: MCSession, didReceive data: Data, fromPeer peerID: MCPeerID) {
        if let image = UIImage(data: data) {
            ...
            DispatchQueue.main.async {
                ...
                UIImageWriteToSavedPhotosAlbum(image, self, #selector(bluefriendsViewController.image(_:didFinishSavingWithError:contextInfo:)), nil)
            }
        }
    }
