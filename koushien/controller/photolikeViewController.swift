...
//            let base64String:String? = userDefaults.stringForKey("profile2")
//            appDelegate.profile2 = base64String
//            
...
//            self.view.addSubview(button4)
            ...
            button.addTarget(self, action: #selector(photolikeViewController.onClickbutton(_:)), for: .touchUpInside)
            ...
            button2.addTarget(self, action: #selector(photolikeViewController.onClickbutton2(_:)), for: .touchUpInside)
...
//        let targetView: AnyObject = self.storyboard!.instantiateViewControllerWithIdentifier( "bluetooth1" )
