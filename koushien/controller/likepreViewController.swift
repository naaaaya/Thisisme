...
class likepreViewController: UIViewController {
    let view0 = UIView()
    let view1 = UIView()
    let view2 = UIView()
    let image1 = UIImage()
...
//        mainImageView.image = img
        ...
        namelabel.layer.position = CGPoint(x: 165,y: 220)
        ...
        schoollabel.layer.position = CGPoint(x: 165,y: 300)
        ...
        yearlabel.layer.position = CGPoint(x: 165,y: 330)
        ...
        clublabel.layer.position = CGPoint(x: 165,y: 360)
        ...
        instalabel.layer.position = CGPoint(x: 165,y: 430)
        ...
        facelabel.layer.position = CGPoint(x: 165,y: 460)
        ...
        maillabel.layer.position = CGPoint(x: 165,y: 500)
    ...
    @IBAction func saveButton(){
        ...
        let userDefaults = UserDefaults.standard
        // NSUserDefaultsインスタンスの生成
        userDefaults.set(encodeString,forKey: "profile4")
        userDefaults.synchronize()
        
        // キー: "saveText" , 値: "" を格納。（idは任意）
        let appDelegate:AppDelegate = UIApplication.shared.delegate as! AppDelegate
        //AppDelegateのインスタンスを取得
        let profile4: String? = userDefaults.string(forKey: "profile4")
        // キーが"saveText"のStringをとります
        appDelegate.profile4 = profile4
        //appDelegateの変数を操作
