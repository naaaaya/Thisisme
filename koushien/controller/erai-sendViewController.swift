...
import UIKit
import Social
class erai_sendViewController: UIViewController {
...
//            let base64String:String? = userDefaults.stringForKey("profile3")
...
//
            ...
            button.addTarget(self, action: #selector(erai_sendViewController.onClickbutton(_:)), for: .touchUpInside)
            ...
            button2.addTarget(self, action: #selector(erai_sendViewController.onClickbutton2(_:)), for: .touchUpInside)
...
//        //結果を返却
//        
//        let shareText = "私の名刺です！よろしくお願いします。"
//        let shareImage = img!
